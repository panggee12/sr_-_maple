...
class CMeteo_Skill final : public CSkill
{
	enum STATE { STATE_IDLE, STATE_LEFT, STATE_RIGHT, STATE_ATTACK, STATE_END };

private:
	CMeteo_Skill(LPDIRECT3DDEVICE9 pGraphic_Device);
	CMeteo_Skill(const CMeteo_Skill& rhs);
	virtual ~CMeteo_Skill() = default;
...
public:
	static CMeteo_Skill* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
